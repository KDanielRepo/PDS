...
class DirectoryImpl extends POADirectory.dirinfo.DirectoryPOA {
	private String root; // katalog root udostpniany
	...
	public String getFileInfo(String filename){
		...
		if (tmpfile.isDirectory())
			answer = " is DIRECTORY, hidden=" + hidden + ", modified "+ modified; 
		else
			answer = " is FILE, length " + tmpfile.length() + "B, hidden=" + hidden+
", modified "+ modified;
		return answer;
	}
} // DirectoryImpl